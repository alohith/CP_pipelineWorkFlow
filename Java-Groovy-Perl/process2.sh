...
echo "./renameWavelengths.pl /data1/tmp/$1.$4.dirty.csv \"$5\" >/data1/tmp/$1.$4.renamed.csv"
      ./renameWavelengths.pl /data1/tmp/$1.$4.dirty.csv "$5" >/data1/tmp/$1.$4.renamed.csv
...
cp /data1/tmp/$1.$4.renamed.csv /data1/tmp/$1.$4.temp.csv

./transpose.pl -d , /data1/tmp/$1.$4.temp.csv >$1.$4.csv

cp -p $1.$4.csv ~/cyto_output/.
cp -p $1.$4.csv /var/www/html/cyto/.
...
rm -f /data1/tmp/$1.$4.renamed.csv
rm -f /data1/tmp/$1.$4.temp.csv
